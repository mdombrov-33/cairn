# Archive — Cairn Design Document v5

> Archived on 2026-07-11 when the active roadmap was made forward-only. This
> preserves the design record and the full locked specifications. It is not a
> description of the current implementation and its package paths are often
> historical. For current architecture, read `../architecture.md`; for the
> ordered future plan, read `../roadmap.md` and then the linked section here.
