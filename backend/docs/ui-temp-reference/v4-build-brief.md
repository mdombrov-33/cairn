...
3. **Billing / tiers** — Phase-B visual-only, speculative; Free / Plus / Pro account tiers automatically select the Luna / task-routed Terra / Sol-narrator bundles and feature caps. Local Qwen is developer-only.
...
19. **Settings** — agency preset · death mode · content/tone · verbosity terse/normal/lush · Advanced (companion agency · your reactions ai/suggest/player · passive checks). Model routing is account-tier-owned and does not appear here.
