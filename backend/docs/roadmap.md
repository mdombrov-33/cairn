...
the remaining audited typed-SRD convergence repair. It does not introduce
combat, reaction, or MCP behavior. Slice 10.5's archived file map is historical:
...
| --- | --- | --- | --- | --- |
| 1 | **Next** | Typed armor catalog migration | Finish the audited typed-SRD caller conversion outside frozen combat code. | — |
| 2 | Planned | 10.5 | Deterministic combat execution and reactions; depends on the existing zones and campaign settings. | [Reaction engine](archive/design-v5.md#slice-105--reaction-engine) |
| 3 | Planned | 10.7 | Tool registry and FastMCP server; begins only after the 10.5 combat surface is final. | [MCP server + tool registry](archive/design-v5.md#slice-107--mcp-server--tool-registry) |
| 4 | Planned | 11 | Operational hardening before evaluation and frontend SSE work. | [Operational hardening](archive/design-v5.md#slice-11--operational-hardening) |
| 5 | Planned | 12 | Eval suite and CI gate; depends on Slice 11's complete event history. | [Eval suite + CI gate](archive/design-v5.md#slice-12--eval-suite--ci-gate) |
| 6 | Planned | 13 | World-bible retrieval; depends on the Slice 12 baseline for tuning. | [World bible retrieval](archive/design-v5.md#slice-13--world-bible-retrieval-rag) |
| 7 | Planned, Phase B | 14 | Authentication and cost controls. | [Auth + cost controls](archive/design-v5.md#slice-14--auth--cost-controls) |
| 8 | Planned, Phase B | 14.5 | Plans and entitlements; depends on account identity from Slice 14. | [Plans & entitlements](archive/design-v5.md#slice-145--plans--entitlements) |
