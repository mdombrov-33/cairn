...
- Inventory UX — ~~simple list with equipped badge; drag-and-drop v2~~ **superseded 2026-07 (Decision 9): slot-based inventory (body slots + pack grid, drag-to-equip) is the target; needs the slot-taxonomy dep.**
