...
settings (whose JSONB representation remains a dictionary at persistence boundaries) and turn
workflows: `pipelines/turn_graph.py` owns graph construction and routing while
`application/turns/` owns resolver persistence and agent coordination.
